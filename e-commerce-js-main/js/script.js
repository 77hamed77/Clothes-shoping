...
const selectProducts = products.slice(4,7)
function drawItems() {
  // Trending Products 
let y = selectProducts.map((item) => {
  return `
        <div class="col">
...
trendingProducts.innerHTML = y
// Best Seller
const selectProducts1 = products.slice(0,6)
let z = selectProducts1.map((item) => {
  return `
